...
`wget -qO- /tmp https://github.com/LantosBro/InstallWindowsOnHetzner/raw/main/vkvm.tar.gz | tar xvz -C /tmp`
...
`wget -qO- /tmp https://github.com/LantosBro/InstallWindowsOnHetzner/raw/main/uefi.tar.gz | tar -xvz -C /tmp`
